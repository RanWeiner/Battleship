...
public class GameActivity extends AppCompatActivity implements MySensorService.DevicePositionChangedListener {
    ...
    private MySensorService.LocalBinder mBinder;
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            mBinder = (MySensorService.LocalBinder) service;
